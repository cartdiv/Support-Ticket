                        ...
                        <ul class="navbar-nav header-right">
							...
							@endphp
								...
								<li class="nav-item dropdown header-profile">
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
										<img src="{{ (!empty($user->photo))?url('upload/tenant_photo/'.$user->photo):url('upload/no_image.jpg') }}" width="20" alt="">
									</a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{route('tenant.edit.profile')}}" class="dropdown-item ai-icon">
                                    ...
                                    <a href="{{route('tenant.change.password')}}" class="dropdown-item ai-icon">
                                    ...
                                    <a href="{{route('tenant.logout')}}" class="dropdown-item ai-icon">

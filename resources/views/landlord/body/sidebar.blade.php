            ...
            <div class="dropdown header-profile2 ">
                <a class="nav-link " href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-end">
						<a href="{{route('landlord.edit.profile')}}" class="dropdown-item ai-icon ">
							<svg  xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
							<span class="ms-2">Profile </span>
						</a>
						<a href="{{route('landlord.change.password')}}" class="dropdown-item ai-icon">
						...
						<a href="{{route('landlord.logout')}}" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('all.tenants')}}">All Tenants</a></li>
                            <li><a href="{{route('active.tenant')}}">Active Tenants</a></li>
                            <li><a href="{{route('inactive.tenant')}}">Inactive Tenants</a></li>
                        </ul>
                    </li>
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="{{route('active.users')}}">Active Users</a></li>
                        <li><a href="{{route('inactive.users')}}">InActive Users</a></li>
                    </ul>
                </li>

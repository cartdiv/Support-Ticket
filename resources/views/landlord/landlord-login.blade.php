...
<head>
   <meta charset="utf-8">
	...
	<meta property="og:title" content="Landlord Login">
                                ...
                                <div class="auth-form">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control" value="landlord@gmail.com">
                                        </div>
                                        <div class="mb-3">
                                            <label class="mb-1"><strong>Password</strong></label>
                                            <input type="password" name="password" class="form-control" value="111">
                                        </div>
                                    ...
                                    <div class="new-account mt-3">
                                        <p>Don't have an account? <a class="text-primary" href="{{ __('Log in') }}">Sign up</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
